    ...
    return (
        <div className='flex'>
            ...
            <div className='p-10'>
                ...
                <p>
                    This ain't your grandma's 3D modeling software! With gOOpy
                    you can create wild shapes and watch in fascination and
                    intrigue as they gOOp together! Join our vibrant community
                    of gOOpers, view their artworks, and get gOOpy today!
                </p>
                ...
                <p>
                    Don't forget to save! Don't forget the URL - this is your
                    unique scene ID!
                </p>
                <img
                ...
                <p>
                    And when you're done, you can download an image to keep!
